#define NGX_CONFIGURE " --with-cc=aarch64-linux-gnu-gcc --with-pcre=/home/raj/nginx/pcre-8.39 --with-zlib=/home/raj/nginx/zlib-1.2.8 --with-openssl=/home/raj/nginx/openssl --with-cpp=aarch64-linux-gnu-g++"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.9.2 20140904 (prerelease) (crosstool-NG linaro-1.13.1-4.9-2014.09 - Linaro GCC 4.9-2014.09) "
#endif
