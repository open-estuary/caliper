(function ($) {
    ...
    $.fn.grid = function (data, columns, options) {
        ...
        plugin.renderData = function () {
            ...
            // just for drawing the table without the empty row
    ...
    $.fn.testPoint = function(classify){
        var dic_data = {}
        $.getJSON("SUBPC-5.json", function(data){
            dic_data = data.classify;
        });
        return dic_data
    };

    $.fn.testcases = function(classify, testpoint){
    };
