...
$(function () {
    ...
    var openblas_efficiency_dic = getJson(test, 'openblas_efficiency_10_cores')
    var columns = getHoriColumn(openblas_efficiency_dic);
    var data = getHoriData(openblas_efficiency_dic, columns);

    // initialize grid
    var options = {emptyRow: true, sortable: false};
    var grid = $(document.getElementById("cpu_multicore_openblas_efficiency_10_cores")).grid(data, columns, options);
