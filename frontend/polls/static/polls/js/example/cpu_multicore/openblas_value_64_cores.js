...
$(function () {
    ...
    var openblas_value_dic = getJson(test, 'openblas_value_64_cores')
    var columns = getHoriColumn(openblas_value_dic);
    var data = getHoriData(openblas_value_dic, columns);

    // initialize grid
    var options = {emptyRow: true, sortable: false};
    var grid = $(document.getElementById("cpu_multicore_openblas_value_64_cores")).grid(data, columns, options);
