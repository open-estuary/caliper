...
$(function () {
	...
	alg_data = [["digital_hash", "openssl", "141623", "231036", "196327", "142684"],
				["digital_sign", "openssl", "2403", "3907", "2466", "983"],
				["digital_verify","openssl", "5233", "8523", "5463", "1873"],
				["symmetric_cyphers", "openssl", "65146", "106244", "90870", "71292"]]
    // generate data
	var data = [];
	for (var i = 0; i < alg_data.length; ++i) {
		data.push({
			"test_case": alg_data[i][0],
            "tool": alg_data[i][1],
            "rh2285-v1": alg_data[i][2],
            "rh2285-v2": alg_data[i][3],
            "i5_pc": alg_data[i][4],
            "d02": alg_data[i][5]
		});
	}
