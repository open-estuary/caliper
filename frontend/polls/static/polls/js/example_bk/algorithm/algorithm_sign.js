...
$(function () {
	...
	sign_data = [["dsa", "openssl", "5484", "8903", "5476", "2136"],
				["ecdsa", "openssl", "1856", "3028", "2149", "1013"],
				["rsa","openssl", "1363", "2212", "1273", "438"]]
	...
	for (var i = 0; i < sign_data.length; ++i) {
		data.push({
            ...
            "tool": sign_data[i][1],
            "rh2285-v1": sign_data[i][2],
            "rh2285-v2": sign_data[i][3],
            "i5_pc": sign_data[i][4],
            "d02": sign_data[i][5]
		});
	}
