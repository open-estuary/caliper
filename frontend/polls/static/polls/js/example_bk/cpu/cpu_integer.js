...
$(function () {
    ...
    integer_data = [["coremark", "coremark", "10799", "17636", "11364", "6795"],
				["integer_add", "lmbench", "4348", "7143", "7143", "2083"],
				["integer_bit", "lmbench", "2174", "3571", "3448","2083"],
				["integer_div", "lmbench", "102", "167", "144", "191"],
				["integer_mod", "lmbench", "94", "153", "147", "233"],
				["integer_mul", "lmbench", "735", "1205", "1149", "699"]]
				
    // generate data
	var data = [];
	for (var i = 0; i < integer_data.length; ++i) {
		data.push({
			"test_case": integer_data[i][0],
            "tool": integer_data[i][1],
            "rh2285-v1": integer_data[i][2],
            "rh2285-v2": integer_data[i][3],
            "i5_pc": integer_data[i][4],
            "d02": integer_data[i][5]
		});
	}
