...
$(function () {
   	...
   	io_data = [["iozone_read", "iozone", "929530", "812087", "104506", "106472"],
				["iozone_rw", "iozone", "90453", "106898", "66905", "81089"],
				["iozone_write", "iozone", "1017433", "816473", "101675", "104202"]]
				
    // generate data
	var data = [];
	for (var i = 0; i < io_data.length; ++i) {
		data.push({
			"test_case": io_data[i][0],
            "tool": io_data[i][1],
            "rh2285-v1": io_data[i][2],
            "rh2285-v2": io_data[i][3],
            "i5_pc": io_data[i][4],
            "d02": io_data[i][5]
		});
	}
