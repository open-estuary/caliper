...
$(function () {
	...
	latency_data = [["ctx", "lmbench", "246", "116", "153", "387"],
				["file/vm", "lmbench", "219", "273", "216", "149"],
				["process", "lmbench", "290", "321", "193", "180"]]
				
    // generate data
	var data = [];
	for (var i = 0; i < latency_data.length; ++i) {
		data.push({
			"test_case": latency_data[i][0],
            "tool": latency_data[i][1],
            "rh2285-v1": latency_data[i][2],
            "rh2285-v2": latency_data[i][3],
            "i5_pc": latency_data[i][4],
            "d02": latency_data[i][5]
		});
	}
