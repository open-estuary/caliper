...
$(function () {
	...
	cachebench_data = [["cachebench_read", "cachebench", "1865", "3037", "2623", "3195"],
				["cachebench_rmw", "cachebench", "10974", "17896", "16193", "13690"],
				["cachebench_write", "cachebench", "8162", "13355", "8542", "7359"]]
				
    // generate data
	var data = [];
	for (var i = 0; i < cachebench_data.length; ++i) {
		data.push({
			"test_case": cachebench_data[i][0],
            "tool": cachebench_data[i][1],
            "rh2285-v1": cachebench_data[i][2],
            "rh2285-v2": cachebench_data[i][3],
            "i5_pc": cachebench_data[i][4],
            "d02": cachebench_data[i][5]
		});
	}
